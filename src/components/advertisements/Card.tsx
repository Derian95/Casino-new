...
export const Card: FC<Props> = ({ title, image, type }) => {
    ...
    <motion.div
			...
			<img src={image} alt='' className='group-hover:scale-110 transition-transform duration-500   object-cover w-full h-[200px]' />
			
			<span className='text-[10px] font-semibold bg-[#BDD2FF] text-[#0A47C9] max-w-fit px-2 py-1'>{ type }</span>
