...
export const Footer = () => {
	return (
		<div className='min-w-screen min-h-[50vh] bg-[#0A47C9] flex justify-center items-center py-20'>
			<div className='max-w-5xl w-full text-white h-full flex justify-center px-5'>
