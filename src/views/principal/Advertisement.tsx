...
//   }, [pathname]);
	...
	return (
		<div className='ra min-w-screen h-auto py-36  mt-20 md:mb-0 bg-red-900 flex flex-col gap-10 justify-center items-center  ' id='anun'>
			...
			className='text-[#FF0C0C] font-normal mb-10'>ANUNCIOS</motion.span>
			<motion.h2
			variants={variantsText}
			initial='initial'
			whileInView='show'
			viewport={{once:true}}
			transition={{ duration: 0.5, delay: 0.2, type: 'tween' }} className='text-[38px] text-[#212529] font-bold  max-w-lg mb-10 text-center'>
